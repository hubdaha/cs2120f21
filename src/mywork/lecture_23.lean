...
--def symmetric: if a is related to b, then b is related to a. 
-- def transitive - if a is related to b and b is related to c then a is related to c.
-- Exercises:
/-
...
example : ¬ reflexive r ↔ irreflexive r := _  -- this is false. 
...
-- the tc of a binary relation is the smallest relation r exact ⊆ of r' such 
-- that r is a sebrelation and r' is transitive
/- 
Reflecting
